    ...
    <main className="min-h-screen bg-gray-50">
      <div className="p-6 mx-auto container space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card className="bg-white border-0 shadow-sm">
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-medium text-teal-600">Pending Review</CardTitle>
            </CardHeader>
            <CardContent>
            ...
            <Table>
              <TableBody>
                {reviewsData.length === 0 ? (
                  <TableRow>
                    <TableCell className="py-16 text-center text-gray-500">
                  ...
                  reviewsData.map((review: Review) => (
                    <TableRow
                      key={review._id}
                      className="bg-white rounded-xl border border-gray-200 hover:shadow-md transition block my-4"
                    >
                      <TableCell className="block p-6">
                        ...
                        {/* Comment */}
                        <p className="text-gray-700 text-sm mt-4">{review.comment}</p>
      ...
      <ReviewsModal modalOpen={modalOpen} onModalChange={setModalOpen} data={selectedReview} />
    </main>
  );
}
